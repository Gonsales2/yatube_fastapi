...
class GroupUseCase:
    ...
    async def get_groups(self, skip: int = 0, limit: int = 100) -> List[dict]:
        groups = await self.group_repo.get_all(skip, limit)
    ...
    async def get_group_by_slug(self, slug: str) -> dict:
