...
@router.post("/", status_code=status.HTTP_201_CREATED, summary="Загрузить одно изображение")
...
@router.post("/multiple/", status_code=status.HTTP_201_CREATED, summary="Загрузить несколько изображений")
